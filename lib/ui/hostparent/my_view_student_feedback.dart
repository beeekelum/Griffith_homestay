...
class ViewFeedbackFromStudent extends StatefulWidget {
  ViewFeedbackFromStudent({this.hostFeedback});
  final DocumentSnapshot hostFeedback;
  @override
  _ViewFeedbackFromStudentState createState() =>
      _ViewFeedbackFromStudentState();
}

class _ViewFeedbackFromStudentState extends State<ViewFeedbackFromStudent> {
